...
namespace Scaffolding.Controllers
{
    public class StudentCoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentId,CourseId,CancelDate,SignDate")] StudentCourse studentCourse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,CourseId,CancelDate,SignDate")] StudentCourse studentCourse)
        {
